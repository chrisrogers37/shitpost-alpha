...
class TestGetPredictionStats:
    ...
    def test_returns_stats_dict(self, mock_execute):
        ...
        mock_execute.return_value = (
            ...
            ['total_posts', 'analyzed_posts', 'completed_analyses', 'bypassed_posts', 'avg_confidence', 'high_confidence_predictions']
        )
...
class TestGetRecentSignals:
    ...
    def test_returns_dataframe(self, mock_execute):
        ...
        mock_execute.return_value = (
            [(datetime.now(), 'test text', 'post123', 1, ['AAPL'], {'AAPL': 'bullish'}, 0.8, 'thesis', 'completed', 'AAPL', 'bullish', 1.5, 2.0, 3.0, True, True, True, 30.0, True)],
            ['timestamp', 'text', 'shitpost_id', 'prediction_id', 'assets', 'market_impact', 'confidence', 'thesis', 'analysis_status', 'symbol', 'prediction_sentiment', 'return_t1', 'return_t3', 'return_t7', 'correct_t1', 'correct_t3', 'correct_t7', 'pnl_t7', 'is_complete']
        )
...
class TestGetPerformanceMetrics:
    ...
    def test_returns_metrics_dict(self, mock_execute):
        ...
        mock_execute.return_value = (
            ...
            ['total_outcomes', 'correct_t7', 'incorrect_t7', 'evaluated_t7', 'avg_return_t7', 'total_pnl_t7', 'avg_confidence']
        )
...
class TestGetAccuracyByConfidence:
    ...
    def test_returns_dataframe(self, mock_execute):
        ...
        mock_execute.return_value = (
            ...
            ['confidence_level', 'total', 'correct', 'incorrect', 'avg_return', 'total_pnl']
        )
...
class TestGetSimilarPredictions:
    ...
    def test_returns_dataframe_for_asset(self, mock_execute):
        ...
        mock_execute.return_value = (
            [(datetime.now(), 'test text', 'post123', 0.8, {'AAPL': 'bullish'}, 'thesis', 'bullish', 1.0, 2.0, 3.0, True, 30.0, 150.0, 154.5)],
            ['timestamp', 'text', 'shitpost_id', 'confidence', 'market_impact', 'thesis', 'prediction_sentiment', 'return_t1', 'return_t3', 'return_t7', 'correct_t7', 'pnl_t7', 'price_at_prediction', 'price_t7']
        )
...
class TestGetPredictionsWithOutcomes:
    ...
    def test_returns_dataframe(self, mock_execute):
        ...
        mock_execute.return_value = (
            [(datetime.now(), 'test text', 'post123', 1, ['AAPL'], {'AAPL': 'bullish'}, 0.8, 'thesis', 'completed', None, 'AAPL', 'bullish', 1.0, 2.0, 3.0, True, True, True, 30.0, True)],
            ['timestamp', 'text', 'shitpost_id', 'prediction_id', 'assets', 'market_impact', 'confidence', 'thesis', 'analysis_status', 'analysis_comment', 'outcome_symbol', 'prediction_sentiment', 'return_t1', 'return_t3', 'return_t7', 'correct_t1', 'correct_t3', 'correct_t7', 'pnl_t7', 'is_complete']
        )
...
class TestLoadFilteredPosts:
    ...
    def test_returns_dataframe(self, mock_execute):
        ...
        mock_execute.return_value = (
            [(datetime.now(), 'test text', 'post123', 10, 5, 20, ['AAPL'], {'AAPL': 'bullish'}, 'thesis', 0.8, 'completed', None)],
            ['timestamp', 'text', 'shitpost_id', 'replies_count', 'reblogs_count', 'favourites_count', 'assets', 'market_impact', 'thesis', 'confidence', 'analysis_status', 'analysis_comment']
        )
