...
|----------|---------|----------|--------|
| [01_CURRENT_STATE.md](./01_CURRENT_STATE.md) | Architecture reference | Reference | ✅ Current |
...
| [04_ASSET_DEEP_DIVE.md](./04_ASSET_DEEP_DIVE.md) | New /assets/{symbol} pages | P1 | Pending |
| [05_SIGNAL_FEED.md](./05_SIGNAL_FEED.md) | Real-time signal feed | P2 | Pending |
| [06_ALERTING_SYSTEM.md](./06_ALERTING_SYSTEM.md) | Push notifications | P2 | Pending |
| [07_DATA_LAYER_EXPANSION.md](./07_DATA_LAYER_EXPANSION.md) | New queries & caching | P1 | Partial |
...
> **STATUS: ✅ PARTIALLY COMPLETE** - Dashboard enhancements done, data layer expansion and testing strategy pending.
...
2. **Data Layer** (07_DATA_LAYER_EXPANSION.md) - PENDING
   - [ ] Add caching for expensive queries
   - [x] Create time-filtered query variants (partial - basic `days` param added)
   - [ ] Add aggregate statistics functions

3. **Testing** (08_TESTING_STRATEGY.md) - IN PROGRESS
   - [ ] Achieve 80%+ test coverage (currently ~67 tests)
...
├── layout.py       # Components, callbacks, styling (~900 lines)
├── data.py         # Database queries (13 functions)
...
- [ ] 80%+ test coverage (in progress - currently 67 tests)
